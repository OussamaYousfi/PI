 ...
 */
public class InterfaceAutoEcoleController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        /* IuserService is = null;
         is = new UserService();
            ...
            Image image = new Image(u.getPath());
            img.setImage(image);*/
        /////////
    ...
    @FXML
    private void AjouterTest(ActionEvent event) throws IOException {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("AjouterTestAutoecole.fxml"));
    ...
    @FXML
    private void deleteTest(ActionEvent event) throws IOException {

        FXMLLoader loader = new FXMLLoader(getClass().getResource("SupprimerTestAutoecole.fxml"));
        Parent root = loader.load();
        img.getScene().setRoot(root);
    }
